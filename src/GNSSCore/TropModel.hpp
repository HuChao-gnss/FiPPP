...
namespace gpstk
{
    ...
    public:
        ...
        virtual void setAllParameters(const CommonTime& time, const Position& rxPos, int flag=1) {};
    ...
    protected:
        ...
        double temp = 15.0;          ///< latest value of temperature (kelvin or celsius)
        double press = 0.0;         ///< latest value of pressure (millibars)
        double humid = 0.7;         ///< latest value of relative humidity (percent)
