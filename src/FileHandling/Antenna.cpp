...
namespace gpstk
{
   ...
   {
         // Add eccentricities
      addAntennaEcc(Antenna::G01, eccL1);
      addAntennaEcc(Antenna::G02, eccL2);
      addAntennaEcc(Antenna::G05, eccL5);
      addAntennaEcc(Antenna::R01, eccL1);
      addAntennaEcc(Antenna::R02, eccL2);
      addAntennaEcc(Antenna::E01, eccL1);
      addAntennaEcc(Antenna::E05, eccL5);
      addAntennaEcc(Antenna::E06, eccL6);
      addAntennaEcc(Antenna::E07, eccL7);
      addAntennaEcc(Antenna::E08, eccL8);
      addAntennaEcc(Antenna::C01, eccL1);
      addAntennaEcc(Antenna::C02, eccL2);
      addAntennaEcc(Antenna::C05, eccL5);
      addAntennaEcc(Antenna::C06, eccL6);
      addAntennaEcc(Antenna::C07, eccL7);
      addAntennaEcc(Antenna::C07, eccL8);
      addAntennaEcc(Antenna::J01, eccL1);
      addAntennaEcc(Antenna::J02, eccL2);
      addAntennaEcc(Antenna::J05, eccL5);
      addAntennaEcc(Antenna::J06, eccL6);
      addAntennaEcc(Antenna::I05, eccL5);
      addAntennaEcc(Antenna::I09, eccL9);
   ...
   {
         // Add eccentricities
      addAntennaEcc(Antenna::G01, NorthEccL1, EastEccL1, UpEccL1);
      addAntennaEcc(Antenna::G02, NorthEccL2, EastEccL2, UpEccL2);
