...
namespace gpstk
{
   ...
   public:
      ...
      enum validBits
      {
         ...
         validIonoCorrBDS = 0x020,  ///< Set if BDS Iono Correction data is valid.
         validIonoCorrQZS = 0x040,  ///< Set if QZS Iono Correction data is valid.
         validIonoCorrIRN = 0x080,  ///< Set if IRN Iono Correction data is valid.
         validTimeSysCorr = 0x100,  ///< Set if Time System Correction is valid.
         validLeapSeconds = 0x400,  ///< Set if the Leap Seconds value is valid.
