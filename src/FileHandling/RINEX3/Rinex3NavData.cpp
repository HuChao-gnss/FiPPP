...
namespace gpstk
{
   ...
   Rinex3NavData::operator GalEphemeris() const throw()
   {
      ...
      gale.transmitTime = GALWeekSecond(week, static_cast<double>(xmitTime),
          TimeSystem::GAL).convertToCommonTime();
      gale.adjustValidity();
...
//      qzse.HOWtime = xmitTime;
   ...
   void Rinex3NavData::getPRNEpoch(Rinex3NavStream& strm)
   {
      try
      {
         ...
         if (satSys == "E") 
             time.setTimeSystem(TimeSystem::GAL);
         if (satSys == "C") 
             time.setTimeSystem(TimeSystem::BDT);
         if (satSys == "J") 
             time.setTimeSystem(TimeSystem::QZS);
         if (satSys == "S") 
             time.setTimeSystem(TimeSystem::GPS);
         ...
         if (strm.header.version < 3)
         {
            ...
            if (satSys == "G")
            {
                af0 = for2doub(line.substr(22, 19));
                af1 = for2doub(line.substr(41, 19));
                af2 = for2doub(line.substr(60, 19));
            }
            else if (satSys == "R" || satSys == "S")
            {
                TauN = for2doub(line.substr(22, 19));
                GammaN = for2doub(line.substr(41, 19));
               MFtime = (long)for2doub(line.substr(60,19));
               if (satSys == "R")
               {
                  ...
                  satSys == "J")
         {
             af0 = for2doub(line.substr(23, 19));
             af1 = for2doub(line.substr(42, 19));
             af2 = for2doub(line.substr(61, 19));
         }
         else if (satSys == "R" || satSys == "S")
         {
             TauN = for2doub(line.substr(23, 19));
             GammaN = for2doub(line.substr(42, 19));
            MFtime = (long)for2doub(line.substr(61,19));
         }
      }
      catch (std::exception &e)
      {
   ...
   void Rinex3NavData::getRecord(const int& nline, Rinex3NavStream& strm)
   {
      ...
      try
      {
         ...
         if (nline == 1)
         {
            ...
            {
                IODE = for2doub(line.substr(n, 19)); n += 19;
                Crs = for2doub(line.substr(n, 19)); n += 19;
                dn = for2doub(line.substr(n, 19)); n += 19;
                M0 = for2doub(line.substr(n, 19));
            }
            else if (satSys == "E")
            {
                IODnav = for2doub(line.substr(n, 19)); n += 19;
                Crs = for2doub(line.substr(n, 19)); n += 19;
                dn = for2doub(line.substr(n, 19)); n += 19;
                M0 = for2doub(line.substr(n, 19));
            }
            ...
            {
                px = for2doub(line.substr(n, 19)); n += 19;
                vx = for2doub(line.substr(n, 19)); n += 19;
                ax = for2doub(line.substr(n, 19)); n += 19;
               health = (short)for2doub(line.substr(n,19));
            }
         }
         ...
         else if (nline == 2)
         {
            if (satSys == "G" || satSys == "E" || satSys == "J" ||
                satSys == "C")
            {
                Cuc = for2doub(line.substr(n, 19)); n += 19;
                ecc = for2doub(line.substr(n, 19)); n += 19;
                Cus = for2doub(line.substr(n, 19)); n += 19;
                Ahalf = for2doub(line.substr(n, 19));
            }
            else if (satSys == "R" || satSys == "S")
            {
                py = for2doub(line.substr(n, 19)); n += 19;
                vy = for2doub(line.substr(n, 19)); n += 19;
                ay = for2doub(line.substr(n, 19)); n += 19;
               if (satSys == "R")
               {
                  freqNum = (short)for2doub(line.substr(n,19));
               }
               else                       // GEO
               {
                   accCode = for2doub(line.substr(n, 19));
               }
            }
         }
         ...
         else if (nline == 3)
         {
            if (satSys == "G" || satSys == "E" || satSys == "J" ||
                satSys == "C")
            {
                Toe = for2doub(line.substr(n, 19)); n += 19;
                Cic = for2doub(line.substr(n, 19)); n += 19;
                OMEGA0 = for2doub(line.substr(n, 19)); n += 19;
                Cis = for2doub(line.substr(n, 19));
            }
            else if (satSys == "R" || satSys == "S")
            {
                pz = for2doub(line.substr(n, 19)); n += 19;
                vz = for2doub(line.substr(n, 19)); n += 19;
                az = for2doub(line.substr(n, 19)); n += 19;
               if (satSys == "R")
               {
                   ageOfInfo = for2doub(line.substr(n, 19));
               }
               else                       // GEO
               {
                   IODN = for2doub(line.substr(n, 19));
               }
            }
         }
         ...
         {
             i0 = for2doub(line.substr(n, 19)); n += 19;
             Crc = for2doub(line.substr(n, 19)); n += 19;
             w = for2doub(line.substr(n, 19)); n += 19;
             OMEGAdot = for2doub(line.substr(n, 19));
         }
         ...
         else if (nline == 5)
         {
            if (satSys == "G" || satSys == "J" || satSys == "C")
            {
                idot = for2doub(line.substr(n, 19)); n += 19;
               codeflgs = (short)for2doub(line.substr(n,19)); n+=19;
               weeknum  = (short)for2doub(line.substr(n,19)); n+=19;
               L2Pdata  = (short)for2doub(line.substr(n,19));
            }
            else if (satSys == "E")
            {
                idot = for2doub(line.substr(n, 19)); n += 19;
               datasources = (short)for2doub(line.substr(n,19)); n+=19;
               weeknum     = (short)for2doub(line.substr(n,19)); n+=19;
            }
         }
         ...
         else if (nline == 6)
         {
            ...
            if (satSys == "G" || satSys == "J")
            {
                accuracy = for2doub(line.substr(n, 19)); n += 19;
               health   = (short)for2doub(line.substr(n,19)); n+=19;
               Tgd = for2doub(line.substr(n, 19)); n += 19;
               IODC = for2doub(line.substr(n, 19));
            }
            else if (satSys == "E")
            {
                accuracy = for2doub(line.substr(n, 19)); n += 19;
               health   = (short)for2doub(line.substr(n,19)); n+=19;
               Tgd = for2doub(line.substr(n, 19)); n += 19;
               Tgd2 = for2doub(line.substr(n, 19));
            }
            else if (satSys == "C")
            {
                accuracy = for2doub(line.substr(n, 19)); n += 19;
         ...
         {
            xmitTime = (long)for2doub(line.substr(n,19)); n+=19;
            if (satSys == "C")
            {
                IODC = for2doub(line.substr(n, 19)); n += 19;
            }
            else
            {
                fitint = for2doub(line.substr(n, 19)); n += 19;
            }
