...
namespace gpstk
{
  ...
  const Rinex3ObsHeader::Fields Rinex3ObsHeader::allValid2({
   ...
   const Rinex3ObsHeader::Fields Rinex3ObsHeader::allValid304({
         Rinex3ObsHeader::validVersion,
            Rinex3ObsHeader::validRunBy,
            Rinex3ObsHeader::validMarkerName,
            //Rinex3ObsHeader::validMarkerType,
   ...
   // added by ragnwang. because of BDS-3 Rinex305 2023-05
   const Rinex3ObsHeader::Fields Rinex3ObsHeader::allValid305({
         Rinex3ObsHeader::validVersion,
            Rinex3ObsHeader::validRunBy,
            Rinex3ObsHeader::validMarkerName,
            //Rinex3ObsHeader::validMarkerType,
   ...
   getRequired(double version)
   {
       ...
       else if (version < 3.06) return allValid305;
       return Fields();
   }
