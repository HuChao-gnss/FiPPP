...
namespace gpstk
{
   ...
   std::ostringstream& operator<< (std::ostringstream& s, const RinexMetHeader::RinexMetType oneObs)
   {
	   if (oneObs == RinexMetHeader::RinexMetType::PR) s << "PR";
	   else if (oneObs == RinexMetHeader::RinexMetType::TD)  s << "TD";
	   else if (oneObs == RinexMetHeader::RinexMetType::HR)  s << "HR";
	   else if (oneObs == RinexMetHeader::RinexMetType::ZW)  s << "ZW";
	   else if (oneObs == RinexMetHeader::RinexMetType::ZD)  s << "ZD";
	   else if (oneObs == RinexMetHeader::RinexMetType::ZT)  s << "ZT";
	   else if (oneObs == RinexMetHeader::RinexMetType::WD)  s << "WD";
	   else if (oneObs == RinexMetHeader::RinexMetType::WS)  s << "WS";
	   else if (oneObs == RinexMetHeader::RinexMetType::RI)  s << "RI";
	   else if (oneObs == RinexMetHeader::RinexMetType::HI)  s << "HI";
	   else  s << "UnKnow";
	   return s;
   }
} // namespace
