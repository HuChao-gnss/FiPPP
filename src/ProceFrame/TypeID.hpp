...
namespace gpstk
{
    ...
    public:
        ...
        satPCenterC1G, satPCenterC2G, satPCenterC5G,
        satPCenterC1E, satPCenterC5E, satPCenterC7E, satPCenterC8E, satPCenterC6E,
        satPCenterC1C, satPCenterC2C, satPCenterC5C, satPCenterC7C, satPCenterC8C, satPCenterC6C,
        satPCenterC1R, satPCenterC2R, satPCenterC3R, satPCenterC4R, satPCenterC6R,           
        satPCenterC1J, satPCenterC2J, satPCenterC5J, satPCenterC6J,                       

        satPCenterL1G, satPCenterL2G, satPCenterL5G,
        satPCenterL1E, satPCenterL5E, satPCenterL7E, satPCenterL8E, satPCenterL6E,
        satPCenterL1C, satPCenterL2C, satPCenterL5C, satPCenterL7C, satPCenterL8C, satPCenterL6C,
        satPCenterL1R, satPCenterL2R, satPCenterL3R, satPCenterL4R, satPCenterL6R,           
        satPCenterL1J, satPCenterL2J, satPCenterL5J, satPCenterL6J,                       
        ...
        elevation, azimuth, height, // height: receiver station height

        satArc,
        weight, 

        XECEF, YECEF, ZECEF,
        recXECEF, recYECEF, recZECEF, // added by ragn wang for store receiver xyz
        ...
        //--------------------------------------------------//
        // Warning: All parameters to be estimated must     //
        // be placed before dx, dy, and dz,                 //
        // otherwise it will affect the ambiguity fixation. //
        //--------------------------------------------------//

        E, N, U,   // added by ragn wang 2023/03/08
